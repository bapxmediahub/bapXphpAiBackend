...
$phpRoutes = ['/','/shop','/shop/','/product','/cart','/checkout','/about','/contact','/temples','/astrologers','/login','/register','/forgot-password','/reset-password','/account','/reviews','/sri-panchami-spiritual','/spiritual','/categories'];
$isPhpRoute = false;

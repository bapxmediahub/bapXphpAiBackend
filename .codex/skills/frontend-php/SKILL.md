...
- Keep separate direct-action channels, such as phone and email, in separate cards or clearly separated action groups when combining them would make the UI cramped or ambiguous.

...
<section class="journey"><h2>Your spiritual journey in 4 guided steps</h2><div class="journey-steps"><div class="journey-step"><strong>1. Discover</strong><p>Browse curated products and rituals for your needs.</p></div><div class="journey-step"><strong>2. Consult</strong><p>Talk with astrologers and get actionable guidance.</p></div><div class="journey-step"><strong>3. Checkout</strong><p>Place secure orders with a clean and trusted flow.</p></div><div class="journey-step"><strong>4. Transform</strong><p>Receive products and follow temple-backed remedies.</p></div></div></section>
<section class="section"><h2>Featured Products</h2><div class="grid">
    <?php foreach(array_slice($products, 0, 3) as $item): ?>
        <article class="panel">
            ...
            <?php if(!empty($item['slug'])): ?><a class="button-link" href="/product/<?= e($item['slug']) ?>">View product</a><?php endif; ?>
        </article>
    <?php endforeach; ?>
</div></section>

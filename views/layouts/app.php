...
<style>
.astro-search input:focus,.astro-filter select:focus{outline:2px solid var(--color-gold)!important;outline-offset:3px;box-shadow:0 0 0 4px rgba(209,179,104,.18)!important;border-radius:4px}

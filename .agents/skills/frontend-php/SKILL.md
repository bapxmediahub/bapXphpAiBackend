...
- Keep public help guides in `content/docs/*.md` and route each guide through `/docs/{slug}`. Public guides explain customer tasks; internal operating notes remain separate.

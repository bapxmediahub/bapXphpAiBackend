...
final class BlogService {
    ...
    public function save(array $data): array {
        ...
        unset($data['content']);
        $frontmatter = '';
        foreach (['title','slug','category','published','published_at','updated_at','summary','order','excerpt','author','seo_title','seo_description','og_image','image_alt','source_url','template'] as $key) {

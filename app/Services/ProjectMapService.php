...
final class ProjectMapService {
    ...
    public static function registry(): array {
        $routes = [
            ...
            ['method'=>'POST','path'=>'/api/consultations/{id}/status','name'=>'api.consultation.status','page'=>'astrologer/dashboard','controller'=>'ConsultationController@status','services'=>['AuthService','ConsultationService']],

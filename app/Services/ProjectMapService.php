...
final class ProjectMapService {
    ...
    public static function registry(): array {
        $routes = [
            ...
            ['method'=>'GET','path'=>'/checkout','name'=>'checkout','page'=>'public/checkout','controller'=>'PublicController@checkout','services'=>['CartService','ProductService','SecretService','AddressService']],
            ...
            ['method'=>'POST','path'=>'/api/consultations/{id}/bill-time','name'=>'api.consultation.bill-time','page'=>'account/consultation','controller'=>'ConsultationController@billCallTime','services'=>['AuthService','ConsultationService','WalletService']],
            ...
            ['method'=>'GET','path'=>'/docs/{slug}','name'=>'docs.show','page'=>'public/doc','controller'=>'PublicController@doc','services'=>['MarkdownRenderer']],
    ...
    private static function serviceCollections(): array {
        return [
            ...
            'AstrologerAccountService' => ['users', 'astrologers'],

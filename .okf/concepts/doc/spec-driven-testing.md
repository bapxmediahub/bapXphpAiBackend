...
description: 
resource: .agents/skills/playwright-cli/references/spec-driven-testing.md
tags: [reference]
---
...
## Connections
- [references → Playwright Tests](/.agents/skills/playwright-cli/references/playwright-tests.md)
- [references → Request Mocking](/.agents/skills/playwright-cli/references/request-mocking.md)
- [references → Session Management](/.agents/skills/playwright-cli/references/session-management.md)
